...
const Hero: React.FC<HeroProps> = ({ scrollToVideo }) => {
  return (
    <section className="bg-[#002B30] text-white flex items-center py-12 md:py-16">
      <div className="container w-full">
        <div className="max-w-5xl mx-auto space-y-8 fade-in">
          {/* Main headline - larger and prominent */}
          <div className="text-center mb-10">
            <h1 className="text-3xl md:text-5xl font-bold tracking-tight text-[#5EEC3E] leading-tight max-w-4xl mx-auto">
          ...
          <div className="text-center">
            <button 
              ...
              className="inline-flex items-center gap-2 text-[#5EEC3E] hover:text-white transition-colors"
            >
